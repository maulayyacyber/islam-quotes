            ...
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-folder"></i> Edit Category</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="add-user">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_category" value="<?php echo $data_category['nama_category'] ?>" placeholder="Nama Category">
