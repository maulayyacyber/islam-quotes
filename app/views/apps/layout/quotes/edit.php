            ...
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-picture-o"></i> Edit Quotes</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="edit-quotes">
                            <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id_quotes" value="<?php echo $this->encryption->encode($data_quotes['id_quotes']) ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category" id="category">
                                    ...
                                    {
                                        if($row['id_category']== $data_quotes['category_id'])
                                        {
                                            ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="judul_quotes" value="<?php echo $data_quotes['judul_quotes'] ?>" placeholder="Judul Quotes">
                            </div>
