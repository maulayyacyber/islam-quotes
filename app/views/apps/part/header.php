...
<head>
    ...
    <link rel="icon" href="<?php echo base_url() ?>resources/images/favicon.ico">
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>resources/backend/dist/css/lightbox.min.css">
